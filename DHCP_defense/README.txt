...
Defesa:
-> Ao usar o DHCP snooping o Switch guarda os MAC's e as correspondentes interfaces e se pela mesma interface vier outro pedido com um MAC diferente ele 
descarta o pacote.
-> Ao usar o limit rate na interface do kali, estamos a dizer que aquela interface está limitada a 10 pacotes por segundo. 
Se mandar mais o Switch manda a interface abaixo
